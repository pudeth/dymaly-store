...
function getBrandLogoSvg(brandName) {
    ...
    if (normalized === 'apple') {
        return `<svg viewBox="0 0 24 24" width="28" height="28" fill="#1d1d1f" aria-label="Apple logo"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.54c.61-.74 1.04-1.77.92-2.81-.9.04-1.99.6-2.63 1.35-.57.66-.99 1.72-.88 2.76.99.08 1.98-.56 2.59-1.3"/></svg>`;
    }
