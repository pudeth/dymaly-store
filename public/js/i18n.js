    ...
    window.BongI18n = {
        ...
        dict: {
            en: {
                ...
                customer_orders_title: '🛍️ Customer Orders',
                customer_orders_subtitle: 'Real-time order history saved in database. View details and delete orders to manage revenue.',
                clear_all_orders: 'Clear All Orders',
                refresh: 'Refresh',
                stat_total_orders: 'Total Orders',
                saved_in_database: 'Saved in database',
                stat_total_sales_revenue: 'Total Sales Revenue',
                live_sales_total: 'Live sales total',
                ...
                th_items: 'Purchased Items',
                th_total_paid: 'Total Paid',
                th_status: 'Status',
                th_action: 'Action',
                loading_orders: 'Loading orders from database...',
                no_orders_yet: 'No Customer Orders Yet',
                no_orders_yet_desc: 'When customers purchase items from your store, their orders will be saved here in real-time. You can view items, customer details, and delete orders.',
                ...
                admin_profile_hero_title: 'Master Administrator',
                active_session: 'Active Session',
                full_access_role: 'Full Root Privileges',
                verified_admin: 'Verified Super Administrator',
                system_privileges_title: 'Administrator Privileges & System Access',
                system_privileges_desc: 'Your account has unrestricted superuser authority across all store modules',
                privilege_orders_title: 'Orders & Payments',
                privilege_orders_desc: 'Manage orders, verify ABA KHQR payments & status updates',
                privilege_catalog_title: 'Product & Stock Control',
                privilege_catalog_desc: 'Real-time stock recalculation, catalog pricing & items',
                privilege_store_title: 'Storefront Identity',
                privilege_store_desc: 'Branding, logos, hero banners, announcements & contact',
                privilege_cloud_title: 'Cloud Media Storage',
                privilege_cloud_desc: 'Permanent Cloudinary CDN image synchronization',
                account_details_title: 'Account Identity Details',
                account_details_desc: 'Manage your administrator identity, username, and contact information',
                security_center_title: 'Password & Authentication Security',
                security_center_desc: 'Leave password fields blank if you do not want to change your password',
                discard_changes: 'Discard Changes',
                save_profile_changes: 'Save Profile Changes',
                confirm_new_password: 'Confirm New Password',
                login_id_hint: 'Use this username to log in to the admin dashboard',
                ...
                store_part_1_title: 'Identity & Bar',
                store_part_1_sub: 'Logo, Name & Announcement',
                store_part_2_title: 'Hero & Highlights',
                store_part_2_sub: 'Promo Banner & Trust Badges',
                store_part_3_title: 'Contact & Footer',
                store_part_3_sub: 'Location, Social & Copyright',
                next_store_part_2: 'Next: Hero & Highlights (Part 2) →',
                next_store_part_3: 'Next: Contact & Footer (Part 3) →',
                back_store_part_1: '← Back: Identity & Bar (Part 1)',
                back_store_part_2: '← Back: Hero & Highlights (Part 2)',
            ...
            km: {
                ...
                // Admin Orders Management
                customer_orders_title: '🛍️ ការបញ្ជាទិញរបស់អតិថិជន',
                customer_orders_subtitle: 'ប្រវត្តិបញ្ជាទិញជាក់ស្តែងក្នុងប្រព័ន្ធ។ មើលព័ត៌មានលម្អិត និងលុបការបញ្ជាទិញដើម្បីគ្រប់គ្រងចំណូល។',
                clear_all_orders: 'លុបការបញ្ជាទិញទាំងអស់',
                refresh: 'ផ្ទុកឡើងវិញ',
                stat_total_orders: 'ការបញ្ជាទិញសរុប',
                saved_in_database: 'រក្សាទុកក្នុងមូលដ្ឋានទិន្នន័យ',
                stat_total_sales_revenue: 'ចំណូលពីការលក់សរុប',
                live_sales_total: 'ចំណូលផ្ទាល់ជាក់ស្តែង',
                real_time_sync: 'ការធ្វើសមកាលកម្មផ្ទាល់',
                connected: '● បានភ្ជាប់',
                instant_updates: 'បច្ចុប្បន្នភាពភ្លាមៗ',
                th_order_num: 'លេខបញ្ជាទិញ',
                th_date: 'កាលបរិច្ឆេទ',
                th_customer: 'អតិថិជន',
                th_items: 'ទំនិញដែលបានទិញ',
                th_total_paid: 'ចំនួនទឹកប្រាក់ទូទាត់',
                th_status: 'ស្ថានភាព',
                th_action: 'សកម្មភាព',
                loading_orders: 'កំពុងទាញយកការបញ្ជាទិញពីប្រព័ន្ធ...',
                no_orders_yet: 'មិនទាន់មានការបញ្ជាទិញទេ',
                no_orders_yet_desc: 'នៅពេលអតិថិជនបញ្ជាទិញទំនិញពីហាងរបស់អ្នក ការបញ្ជាទិញនឹងបង្ហាញនៅទីនេះភ្លាមៗ។',
                ...
                admin_profile_hero_title: 'គណនីអ្នកគ្រប់គ្រងជាន់ខ្ពស់',
                active_session: 'សម័យដំណើរការសកម្ម',
                full_access_role: 'សិទ្ធិគ្រប់គ្រងពេញលេញ',
                verified_admin: 'បានផ្ទៀងផ្ទាត់ជាអ្នកគ្រប់គ្រងជាន់ខ្ពស់',
                system_privileges_title: 'សិទ្ធិ និងការអនុញ្ញាតរបស់អ្នកគ្រប់គ្រង',
                system_privileges_desc: 'គណនីរបស់អ្នកមានសិទ្ធិគ្រប់គ្រងពេញលេញលើគ្រប់ផ្នែកនៃប្រព័ន្ធហាង',
                privilege_orders_title: 'ការបញ្ជាទិញ & ការទូទាត់',
                privilege_orders_desc: 'គ្រប់គ្រងការបញ្ជាទិញ ផ្ទៀងផ្ទាត់វិក្កយបត្រ ABA KHQR និងបច្ចុប្បន្នភាពស្ថានភាព',
                privilege_catalog_title: 'ការគ្រប់គ្រងទំនិញ & ស្តុក',
                privilege_catalog_desc: 'គណនាស្តុកតាមពេលវេលាជាក់ស្តែង តម្លៃ និងផលិតផល',
                privilege_store_title: 'អត្តសញ្ញាណហាង',
                privilege_store_desc: 'ឡូហ្គោ ផ្ទាំងផ្សាយពាណិជ្ជកម្ម សេចក្តីជូនដំណឹង និងទំនាក់ទំនង',
                privilege_cloud_title: 'ប្រព័ន្ធផ្ទុករូបភាព Cloudinary',
                privilege_cloud_desc: 'រក្សាទុករូបភាពអចិន្ត្រៃយ៍ជាមួយ Cloudinary CDN',
                account_details_title: 'ព័ត៌មានលម្អិតអំពីគណនី',
                account_details_desc: 'គ្រប់គ្រងឈ្មោះអ្នកគ្រប់គ្រង ឈ្មោះសម្គាល់ចូល និងទំនាក់ទំនង',
                security_center_title: 'សុវត្ថិភាពពាក្យសម្ងាត់ និងការផ្ទៀងផ្ទាត់',
                security_center_desc: 'ទុកប្រអប់ពាក្យសម្ងាត់នៅទំនេរ ប្រសិនបើមិនចង់ផ្លាស់ប្តូរពាក្យសម្ងាត់',
                discard_changes: 'បោះបង់ការផ្លាស់ប្តូរ',
                save_profile_changes: 'រក្សាទុកការផ្លាស់ប្តូរ',
                confirm_new_password: 'បញ្ជាក់ពាក្យសម្ងាត់ថ្មី',
                login_id_hint: 'ប្រើឈ្មោះសម្គាល់នេះដើម្បីចូលទៅកាន់ផ្ទាំងគ្រប់គ្រង',
                ...
                store_part_1_title: 'អត្តសញ្ញាណ & សេចក្តីជូនដំណឹង',
                store_part_1_sub: 'រូបសញ្ញា, ឈ្មោះ & ដំណឹង',
                store_part_2_title: 'ផ្ទាំងពាណិជ្ជកម្ម & ការធានា',
                store_part_2_sub: 'បដាផ្សាយ & ផ្លាកសញ្ញាធានា',
                store_part_3_title: 'ទំនាក់ទំនង & ព័ត៌មានបាត',
                store_part_3_sub: 'ទីតាំង, បណ្តាញសង្គម & រក្សាសិទ្ធិ',
                next_store_part_2: 'បន្ទាប់៖ ផ្ទាំងពាណិជ្ជកម្ម & ការធានា (ផ្នែកទី ២) →',
                next_store_part_3: 'បន្ទាប់៖ ទំនាក់ទំនង & ព័ត៌មានបាត (ផ្នែកទី ៣) →',
                back_store_part_1: '← ថយក្រោយ៖ អត្តសញ្ញាណ (ផ្នែកទី ១)',
                back_store_part_2: '← ថយក្រោយ៖ ផ្ទាំងពាណិជ្ជកម្ម (ផ្នែកទី ២)',
            ...
            zh: {
                ...
                // Admin Orders Management
                customer_orders_title: '🛍️ 客户订单管理',
                customer_orders_subtitle: '数据库中存储的实时订单历史记录。可查看明细或删除订单以管理销售业绩。',
                clear_all_orders: '清空所有订单',
                refresh: '刷新订单',
                stat_total_orders: '订单总数',
                saved_in_database: '数据库实时留存',
                stat_total_sales_revenue: '累计销售总额',
                live_sales_total: '实时营收累计',
                real_time_sync: '实时数据流',
                connected: '● 保持连接',
                instant_updates: '毫秒级自动同步',
                th_order_num: '订单号',
                th_date: '下单时间',
                th_customer: '顾客信息',
                th_items: '购买商品明细',
                ...
                th_status: '履约状态',
                th_action: '快捷操作',
                loading_orders: '正在从数据库加载订单列表...',
                no_orders_yet: '暂无客户订单',
                no_orders_yet_desc: '当顾客在商城下单结账后，订单信息将在此处毫秒级实时显示。',
                ...
                new_password: '新密码（可选）',
                update_profile: '更新资料',
                admin_profile_hero_title: '超级管理员账户',
                active_session: '当前在线会话',
                full_access_role: '拥有最高系统权限',
                verified_admin: '已认证超级管理员',
                system_privileges_title: '管理员系统权限与安全状态',
                system_privileges_desc: '您的账户在商城所有业务模块中拥有最高管理权限',
                privilege_orders_title: '订单与支付管理',
                privilege_orders_desc: '全流程处理订单、核验ABA KHQR付款凭据及状态变更',
                privilege_catalog_title: '商品与库存管控',
                privilege_catalog_desc: '实时库存动态计算、价格策略与商品上下架',
                privilege_store_title: '商城品牌与形象',
                privilege_store_desc: '定制店铺Logo、首屏推广横幅、顶部公告栏与联系方式',
                privilege_cloud_title: '图片云端安全存储',
                privilege_cloud_desc: 'Cloudinary CDN 专业云存储自动安全同步',
                account_details_title: '管理员基本资料',
                account_details_desc: '管理您的公开身份昵称、登录账号以及联系方式',
                security_center_title: '密码与身份安全中心',
                security_center_desc: '如无需修改登录密码，请将密码输入框留空即可',
                discard_changes: '放弃修改',
                save_profile_changes: '保存个人资料修改',
                confirm_new_password: '确认新登录密码',
                login_id_hint: '您可以使用此账号登录管理后台仪表盘',
                upload_photo: '上传头像',
                image_link: '图片链接',
                ...
                store_part_1_title: '店铺形象与公告',
                store_part_1_sub: 'Logo、店名与公告栏',
                store_part_2_title: '首页横幅与保障',
                store_part_2_sub: '宣传横幅与服务保证',
                store_part_3_title: '联系方式与页脚',
                store_part_3_sub: '地址、社交与版权',
                next_store_part_2: '下一步：横幅与特色 (第 2 部分) →',
                next_store_part_3: '下一步：联系方式与页脚 (第 3 部分) →',
                back_store_part_1: '← 返回：店铺形象与公告 (第 1 部分)',
                back_store_part_2: '← 返回：横幅与特色 (第 2 部分)',
